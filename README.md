...
[Yandex Flavored Markdown (YFM)](https://www.npmjs.com/package/@yfm/transform). Например, как [документация Яндекс.Облака](https://cloud.yandex.ru/docs).
...
- `--vars, -v`
    ...
    Значения [YFM переменных](https://github.yandex-team.ru/data-ui/yfm/blob/master/DOCS.md#vars)
...
- скопированы все файлы, которые указаны в файлах оглавления, и используемые в них картинки и [файлы вставок](https://github.yandex-team.ru/data-ui/yfm/blob/master/DOCS.md#includes).

Подробнее про переменные и условия в [документации YFM](https://github.yandex-team.ru/data-ui/yfm/blob/master/DOCS.md#vars).
