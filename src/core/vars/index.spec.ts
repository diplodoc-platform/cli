    ...
    describe('service', () => {
        describe('proxy', () => {
            ...
            it('should track dependencies', async () => {
                ...
                expect(service.graph.hasNode('presets.yaml#default.field1')).toBeTruthy();
                expect(service.graph.hasNode('presets.yaml#default.override1')).toBeTruthy();
            });
            ...
            it('should track dependencies from scopes', async () => {
                ...
                expect(service.graph.hasNode('presets.yaml#default.field1')).toBeTruthy();
                expect(service.graph.hasNode('presets.yaml#internal.override1')).toBeTruthy();
            });
            ...
            it('should track dependencies for nested objects', async () => {
                ...
                expect(
                    service.graph.hasNode('nested/presets.yaml#default.deep.deep.deep.var'),
                ).toBeTruthy();
            });
            ...
            it('should track missed dependency for nested objects', async () => {
                ...
                expect(service.graph.hasNode('missed#default.deep.deep.deep.missed')).toBeTruthy();
                expect(service.graph.hasNode('missed#internal.deep.deep.deep.missed')).toBeTruthy();
            });
        });
