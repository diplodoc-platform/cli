...
describe('stripHtmlTags', () => {
    ...
    describe('code block protection', () => {
        it('does NOT remove <style> inside fence with leading space (indented fence)', () => {
            // Fenced code blocks can have up to 3 spaces of indentation (CommonMark).
            // Also common inside list items.
            const input = [
                'Text before',
                '',
                ' ```html',
            ...
            // The <style> inside the indented code block must be preserved
