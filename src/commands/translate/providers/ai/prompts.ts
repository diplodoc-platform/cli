...
export const DEFAULT_SYSTEM_PROMPT = dedent`
    ...
    - Never add Markdown that the fragment does not already contain. In particular, do not wrap a fragment or its edges in *, **, _ or __: a fragment is a slice of a line, and the surrounding markup is restored automatically. Extra markers make the line render as ****Release date:** value.
