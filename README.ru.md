...
- `--storage-bucket`
    ...
    Имя бакета в S3 совместимом хранилище.

- `--storage-prefix`

    Префикс корневой директории в S3 совместимом хранилище. По умолчанию `/`.

- `--storage-key-id`

    Идентификатор ключа доступа в S3 совместимом хранилище.

- `--storage-secret-key`

    Секрет ключа доступа в S3 совместимом хранилище.
